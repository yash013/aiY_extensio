...
export default function Home() {
  return (
    <>
              ...
              <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blue-500">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <p className="text-md font-light mt-2 text-white">
                    Believe it or not, ScribeGenie brings ChatGPT's Sorcery to every text box in your browser.
                  </p>
                </blockquote>
              </div>
            </div>
                ...
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">AI-Powered Writing</h6>
                      <p className="mb-4 text-blueGray-500">
                        Leverage advanced AI algorithms to generate creative and engaging content effortlessly.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        Compose emails, posts, tweets, articles, and texts for various platforms with ease.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Customizable Tone And Style</h6>
                      <p className="mb-4 text-blueGray-500">
                        Tailor the writing style to match your brand or personal preferences.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Time-Saving Efficiency</h6>
                      <p className="mb-4 text-blueGray-500">
                        It uses GPT 3.5 Turbo model to boost your productivity and save time.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="pb-16 bg-gray-700 relative pt-32">
        <div className="-mt-20 top-0 bottom-auto left-0 right-0 w-full absolute h-20">
          <svg className="absolute bottom-0 overflow-hidden" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" version="1.1" viewBox="0 0 2560 100" x="0" y="0">
            <polygon className="text-gray-700 fill-current" points="2560 0 2560 100 0 100"></polygon>
          </svg>
        </div>
